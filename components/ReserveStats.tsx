    ...
    <View className='w-full px-4'>
      {['borrow', 'repay'].includes(action) && (
        <Metric
          ...
          tooltip={<Typography>For the purpose of borrowed assets in utilization calculations, the max value between spot price a EMA (exponential moving average) is used. This is to protect the protocol against price manipulation.</Typography>}
        />
      )}
      {['deposit', 'withdraw'].includes(action) && (
        <Metric
          ...
          tooltip={<Typography>For the purpose of supplied assets in utilization calculations, the min value between spot price a EMA (exponential moving average) is used. This is to protect the protocol against price manipulation.</Typography>}
        />
      )}
      <Metric
      ...
      <Metric
        ...
        value={formatPercent(interestType === 'Supply' ? reserve.supplyInterest.toString() : reserve.borrowInterest.toString())}
      />
      {action === 'borrow' && calculatedBorrowFee && (
        <Metric
          ...
          value={
            <Typography>
              {formatToken(calculatedBorrowFee.toString(), 4, false, false, false, true)}{' '}
              {reserve.symbol}
            </Typography>
          }
        />
      ...
      >
        <View className='flex flex-row justify-center items-center'>
          ...
          {showParams ? <Icon name='expand-less'/> : <Icon name='expand-more'/>}
          </View>
        </View>
      </Pressable>
      <ScrollView
        className={showParams ?  'flex bg-neutralAlt h-48 mt-4 mx-[-32px] px-8' : 'flex hidden'}
      ...
      >
              ...
              tooltip={
                <Typography>
                  ...
                  interest rates via a function.{' '}
                    <Typography onPress={() => Linking.openURL('https://docs.solend.fi/protocol/fees')}>Learn more</Typography>
                  .
                </Typography>
              }
            />
            ...
            <Metric
              ...
              tooltip={<Typography>When utilization goes above this value, interest rates are more sensitive to changes in utilization.</Typography>}
            />
            <Metric
              row
              label='Target borrow APR'
              value={formatPercent(reserve.targetBorrowApr)}
              tooltip={<Typography>When utilization is equal to the target utilization, borrow APR will be this value.</Typography>}
            />
            <Metric
              row
              label='Max utilization'
              value={formatPercent(reserve.maxUtilizationRate)}
              tooltip={<Typography>When utilization goes above this value, borrows and withdraws will not be possible.</Typography>}
            />
            <Metric
              row
        ...
        {reserve.reserveSupplyLimit && (
          <Metric
            ...
            tooltip={<Typography>To limit risk, total deposits are limited.</Typography>}
          />
        )}
        {reserve.reserveBorrowLimit && (
          <Metric
            ...
            tooltip={<Typography>The total amount of borrows for this reserve is limited to this amount.</Typography>}
          />
        )}
        <Metric
          row
          ...
          tooltip={<Typography>Open loan-to-value (LTV) is the ratio describing how much you can borrow against your collateral.</Typography>}
        />
        <Metric
          row
          label='Close LTV'
          value={formatPercent(reserve.liquidationThreshold)}
          tooltip={<Typography>Close Loan-to-value (LTV) ratio at which liquidation occurs.</Typography>}
        />
        <Metric
          row
          label='Max close LTV'
          value={formatPercent(reserve.maxLiquidationThreshold)}
          tooltip={<Typography>Max close Loan-to-value (LTV) is the ratio at which the max liquidation penalty occurs.</Typography>}
        />
        <Metric
          row
        ...
        <Metric
          ...
          tooltip={<Typography>Liquidation penalty increases past close LTV until max close LTV, where max liquidation penalty occurs.</Typography>}
        />
        <Metric
          row
        ...
        <Metric
          ...
          tooltip={<Typography>The liquidation protocol fee is a percentage of the liquidation penalty that goes to the Solend DAO treasury to help cover bad debt.</Typography>}
          value={<>{formatPercent(reserve.protocolLiquidationFee)}</>}
        />
        <Metric
          row
          label='Interest rate spread'
          tooltip={<Typography>Interest rate spread is a percentage of the borrow interest rate. The fee percentage ranges depending on the asset.</Typography>}
        ...
        <Metric
          ...
          value={
            <Tooltip actionType='press' popover={<Typography>{reserve.address}</Typography>}>
              <View className='flex flex-row items-center'>
                  <Typography onPress={() => Linking.openURL(`https://solscan.io/account/${reserve.address}`)} onLongPress={() => {
        ...
        <Metric
          ...
          value={
            <Tooltip actionType='press' popover={<Typography>{reserve.liquidityAddress}</Typography>}>
              <View className='flex flex-row items-center'>
                  <Typography onPress={() => Linking.openURL(`https://solscan.io/account/${reserve.liquidityAddress}`)} onLongPress={() => {
        ...
        <Metric
          ...
          value={
            <Tooltip actionType='press' popover={<Typography>{reserve.cTokenLiquidityAddress}</Typography>}>
              <View className='flex flex-row items-center'>
                  <Typography onPress={() => Linking.openURL(`https://solscan.io/account/${reserve.cTokenLiquidityAddress}`)} onLongPress={() => {
                    Clipboard.setString(reserve.cTokenLiquidityAddress);
                    alertAndLog('Address copied!', reserve.cTokenLiquidityAddress)
                  }}>
        ...
        {reserve.feeReceiverAddress && (
          <Metric
            ...
            value={
              <Tooltip actionType='press' popover={<Typography>{reserve.feeReceiverAddress}</Typography>}>
                <View className='flex flex-row items-center'>
                    <Typography onPress={() => Linking.openURL(`https://solscan.io/account/${reserve.feeReceiverAddress}`)} onLongPress={() => {
                        Clipboard.setString(reserve.feeReceiverAddress)
                        alertAndLog('Address copied!', reserve.feeReceiverAddress);
                    }}>
        ...
        <Metric
          ...
          label='Token mint'
          value={
            <Tooltip actionType='press' popover={<Typography>{reserve.mintAddress}</Typography>}>
              <View className='flex flex-row items-center'>
                  <Typography onPress={() => Linking.openURL(`https://solscan.io/account/${reserve.mintAddress}`)} onLongPress={() => {
        ...
        <Metric
          ...
          label='cToken mint'
          value={
            <Tooltip actionType='press' popover={<Typography>{reserve.cTokenMint}</Typography>}>
              <View className='flex flex-row items-center'>
                  <Typography onPress={() => Linking.openURL(`https://solscan.io/account/${reserve.cTokenMint}`)} onLongPress={() => {
            ...
            value={
              rateLimiter.config.windowDuration.isEqualTo(BigNumber(0)) ? (
                ...
                <Typography>
                  ...
                  {reserve.symbol} per{' '}
                  {humanizeDuration(
                    (rateLimiter.config.windowDuration.toNumber() / 2) *
                      1000,
                  )}
                </Typography>
              )
        ...
        {!new BigNumber(reserve.borrowWeight).isEqualTo(new BigNumber(0)) && (
          <Metric
            ...
            tooltip={<Typography>Borrow weight is a coefficient that is applied to the value being borrowed. This allows for the risk management on the borrowing of assets of various risk levels.</Typography>}
          />
        )}
        {reserve.pythOracle !==
          ...
          <Metric
            ...
            label='Pyth oracle'
            value={
              <Tooltip popover={<Typography>{reserve.pythOracle}</Typography>} actionType='press'>
                <View className='flex flex-row items-center'>
                    <Typography onPress={() => Linking.openURL(getPythLink(reserve.pythOracle, reserve.symbol))} onLongPress={() => {
        ...
        <Metric
          ...
          value={
            <Tooltip popover={<Typography>{reserve.switchboardOracle}</Typography>} actionType='press'>
              <View className='flex flex-row items-center'>
                  <Typography onPress={() => Linking.openURL(`https://solscan.io/account/${reserve.switchboardOracle}`)} onLongPress={() => {
